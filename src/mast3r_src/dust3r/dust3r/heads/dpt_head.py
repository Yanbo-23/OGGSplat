...
class DPTOutputAdapter_fix(DPTOutputAdapter):
    ...
    def forward(self, encoder_tokens: List[torch.Tensor], image_size=None):
        ...
        # layer[0]: [1, 1024, 1024] [1, 1024, 32, 32] 

        layers = [self.act_postprocess[idx](l) for idx, l in enumerate(layers)]
        #[1, 1024, 32, 32] -> [1, 96, 128, 128] | [1, 768, 32, 32] -> [1, 192, 64, 64] | [1, 768, 32, 32] -> [1, 384, 32, 32] | [1, 768, 32, 32] -> [1, 768, 16, 16]
        # print(layers[0].shape,layers[1].shape,layers[2].shape,layers[3].shape)
        # awdwa
        # Project layers to chosen feature dim
        # channel: 1024/768 -> 256
