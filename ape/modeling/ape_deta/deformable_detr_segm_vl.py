...
class DeformableDETRSegmVL(DeformableDETR):
    ...
    def forward(self, batched_inputs, do_postprocess=True):
        ...
        for lvl in range(inter_states.shape[0]):
            ...
            if prompt == "name":
                ...
                outputs_class = self.class_embed[lvl](inter_states[lvl], features_l, lvl)
        ...
        # print(inter_states[-1].shape,outputs_class.shape)
        # awdwa
        ...
        # torch.save(self.class_embed[5].state_dict(), './models/vl_algin_weights.pth')
        # torch.save(self.model_language.state_dict(), './models/lang_weights.pth')
        # awdaw
    ...
    def _postprocess_semantic(
        ...
        for mask_cls, mask_pred, vi, input_per_image, image_size in zip(
            ...
            # print(result.shape,torch.unique(result),'1111')
            
            r = sem_seg_postprocess(result, image_size, height, width) if vout else 1
            # print(r.shape,torch.unique(r),'2222')
            # awdawdwa
