...
class DefaultPredictor:
    ...
    def __init__(self, cfg):
        ...
        #     if 'model_language' in name:
        #         print(f"Parameter name: {name}, shape: {param.shape}")
        # state_dict = self.model.model_vision.transformer.decoder.class_embed.state_dict()
        # updated_params = {}
        # for name, param in state_dict.items():
        #     if 'dot_product_projection_text.bias' in name:
        #         print(name,param)
        #     if '5.' in name:
        #         # 重命名 'test' 为 'ktest'
        #         new_name = name.replace('5.', '')
        #         updated_params[new_name] = param
        #     else:
        #         pass

        # torch.save(updated_params, './models/vl_algin_weights.pth')
        # dwadwa
