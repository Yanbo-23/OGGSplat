...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            num_rendered, color, depth, alpha, contri_idx, contri_num, language_feature, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, language_feature, radii, depth, alpha, contri_idx, contri_num
    @staticmethod
    def backward(ctx, grad_out_color, grad_out_language_feature, _, _depth, _alpha, _contri_idx, _contri_acc):
